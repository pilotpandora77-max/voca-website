...
const LESSONS = [
  ...
  { id: 'fill', title: 'Дутуу үг нөхөх', icon: '🅰️', bg: '#FEF3C7', desc: 'Өгүүлбэр дэх дутуу үгийг нөхөж ой тогтоолтоо бататгаарай.', time: '5–15 мин', skills: ['Ойлгох'], href: '/grammar' },
          ...
          <div className="card" style={{ border: '1.5px solid var(--purple-mid)', background: 'linear-gradient(135deg, var(--purple-soft), #fff)', marginBottom: 24 }}>
            <div style={{ display: 'flex', gap: 24, flexWrap: 'wrap' }}>
              <div style={{ flex: '0 0 260px' }}>
                ...
                <Link href="/grammar" className="btn btn-purple" style={{ textDecoration: 'none', padding: '11px 20px' }}>Дүрмийн хичээл рүү →</Link>
              </div>
              <div style={{ flex: 1, minWidth: 280 }}>
                <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: 12 }}>
                  <span style={{ fontWeight: 800, fontSize: 13.5, color: 'var(--text)' }}>Санал болгож буй дүрмүүд</span>
                  <Link href="/grammar" style={{ fontSize: 12, color: 'var(--purple)', fontWeight: 700, textDecoration: 'none' }}>Бүгдийг харах →</Link>
                </div>
                <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(130px, 1fr))', gap: 10 }}>
                  {GRAMMAR_PREVIEW.map(g => (
                    <Link key={g.title} href="/grammar" style={{ textDecoration: 'none', background: '#fff', border: '1.5px solid var(--border)', borderRadius: 12, padding: '12px' }}>
