...
// 'match' (MatchQ, 4-үгийн багц) session бүтээхдээ [id]/take/page.js-д groupId-аар
// хэд хэдэн navigator нүдийг нэг тааруулах асуулт болгон холбож ашигладаг.
export const EXAM_TYPES = [
  { key: 'flashcard', title: 'Флаш карт',        icon: '🗂️' },
  { key: 'choice',    title: 'Сонголттой тест',  icon: '📝' },
  { key: 'match',     title: 'Тааруулах',        icon: '🔗' },
